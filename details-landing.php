 ...
 -->
    ...
    the height of your image it will never show outside this div-->
        ...
        <div class="container mx-auto clearFix">
            ...
            <div class="wrapper">
                <header>
                    <div class="left halfPage">
                        <div class="left imagen tele"> <img src="img/mujer.png" /> </div>
                        <div class="txtCenter left titulo">
                            <h1 class="blanco"> <span class="el">EL<br/></span> <span class="bienestar">BIENESTAR<br/></span> <span class="es">ES DE QUIEN<br/></span> <span class="lo">LO TRABAJA</span> </h1>
                            <p class="azul vive"> <span>Vive atento y relajado</span> </p>
                        </div>
                    </div>
                    <div clas="left halfPage padding0">
                        <div class="video padding0"> <iframe frameborder="0" scrolling="no" src="https://www.youtube.com/embed/_kwC3_xUu2c" allow="autoplay; encrypted-media"> </iframe> </div>
                    </div>
                </header>
                <div class="left fondo">
                    <div class="taller left">
                        <div class="left titulo">
                            <div class="left ">
                                <h2>TALLER </h2>
                            </div>
                            <div class="left"> <img src="img/taller.png" /> </div>
                        </div>
                        <div class="left padding0">
                            <h3 class="padding0"><br/>TEÓRICO-PRÁCTICO</h3>
                        </div>
                        <div class="left">
                            <p> Queremos compartir contigo herramientas que te permitan desarrollar las habilidades necesarias para tener una vida más plena. En este primer módulo de nuestro programa "Trabajar y Vivir en Equilibrio", nos centraremos en clarificar qué es ese bienestar que anhelamos y qué se necesita para cultivarlo. </p>
                            <p> Además de la reflexión teórica, compartiremos técnicas para pasar de las buenas intenciones a la realidad. Al practicarlas, tendrás una mente más tranquila, clara y con espacio para manejar los retos de la vida en familia, en la escuela, con la pareja y en el trabajo. </p>
                            <p> La información que recibirás está sustentada en diversas investigaciones en neurociencias, educación, psicología y reducción de estrés. </p>
                            <p> Lo impartirá la Psic. Lourdes Gómez Paz, instructora de AtentaMente con 10 años de práctica de técnicas para el cultivo de la atención y habilidades socioemocionales. Lulú tiene también 20 años de experiencia en trabajo con grupos. </p>
                        </div>
                    </div>
                    <div class="sabados left ">
                        <div class="cabecera left">
                            <div class=" txtRight left cuatro">
                                <p>4</p>
                            </div>
                            <div class="texto left">
                                <p>SÁBADOS<br/>SESIONES<br/>HORAS<br/></p>
                            </div>
                            <div class="duracion left txtCenter">
                                <p>Duración de 16 horas a lo largo de 4 semanas.</p>
                            </div>
                        </div>
                ...
                <div class="txtCenter left info">
                    <div class="caja forthPage left ">
                        <p class="titulo">HORARIO</p>
                        <p>Sábado</p>
                        <p>9:00 - 13:00 hrs.</p>
                    </div>
                    <div class="caja forthPage left ">
                        <p class="titulo">INVERSIÓN</p>
                        <p>$3,200</p>
                        <p>PRESENCIAL</p>
                        <p>$2,800</p>
                    ...
                    <div class="caja forthPage left ">
                        <p class="titulo">SEDE</p>
                        <p>Club de Banqueros de la CDMX</p>
                        <p>16 de Septiembre 27, Cento Histórico</p>
                    </div>
                    <div class="caja forthPage left">
                        <p class="titulo">IMPARTE</p>
