...
<div class="header-row" id="header-row" style="padding: 0px; overflow:hidden; height:220px;">
...
<div class="col-sm text-center">
      ...
      <div class="description text-center"><br>
            <h3>Apreciamos enormemente tu donativo, muchas gracias por contribuir con nuestros proyectos.</h3>

      </div>
      <div class="item-box">
          <br/><a href="index.php" class="btn btn-outline-secondary" role="button" aria-pressed="true">Regresar a la tienda</a>
      </div>
      <br/><br/>
</div>
   <footer id="footer">
