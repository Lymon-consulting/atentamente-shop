...
<div class="col-sm">
   <li>
      ...
      <?php if($row["id"]==1) echo "<div class='price'>Licencia adicional $ 1750</div>"; ?> <div> <?php if($row["id"]==1) echo " (Incluye 3 licencias)"; ?> <div> <?php if($row["id"]==19) echo " (Pronto pago hasta el 1 de octubre: $1,600)"; ?><div>
      <div class="item-box">
          ...
          <?php 
            if($row["id"]==2){
          ?>
          <a class="btn" href="https://www.amazon.com.mx/dp/B07H47LWVN">Comprar</a>
         <?php 
            }
            else if($row["id"]==3){
          ?>
          <a class="btn" href="https://www.amazon.com.mx/dp/B07H45X1F1">Comprar</a>
         <?php 
            }
            else if($row["id"]==4){
          ?>          
          <a class="btn" href="https://www.amazon.com.mx/dp/B07H452DSZ">Comprar</a>
          <?php 
            }
            else{
          ?>          
